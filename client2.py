...
class ChatClient:
    ...
    def init_ui(self):
        ...
        self.online_button = ctk.CTkButton(self.root, text="Użytkownicy Online", command=self.send_online_request,
                                           width=80, fg_color="#FF69B4", text_color="black")
    ...
    def ask_username(self):
        ...
        confirm_button = ctk.CTkButton(dialog, text="Dołącz", command=on_confirm, fg_color="#FF69B4",
                                       text_color="black")
    ...
    def open_emoji_window(self):
        ...
        for emoji in emojis:
            button = ctk.CTkButton(emoji_window, text=emoji, width=80, height=60, font=("Arial", 22),
                                   command=lambda e=emoji: self.insert_emoji(e), fg_color="#FF69B4", text_color="black",
                                   corner_radius=10)
