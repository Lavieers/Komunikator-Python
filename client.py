...
class ChatClient:
    ...
    def init_ui(self):
        ...
        # Brak fg_color - używa motywu "blue"
        self.send_button = ctk.CTkButton(self.root, text="Wyślij", command=self.send_message, width=80, text_color="black")
        self.send_button.grid(row=1, column=1, padx=10, pady=10)

        self.emoji_button = ctk.CTkButton(self.root, text="Emotki", command=self.open_emoji_window, width=80, text_color="black")
        self.emoji_button.grid(row=1, column=2, padx=10, pady=10)

        self.online_button = ctk.CTkButton(self.root, text="Użytkownicy Online", command=self.send_online_request, width=80, text_color="black")
        ...
        self.received_label = ctk.CTkLabel(self.root, text="Odebrane wiadomości: 0", font=("Arial", 14))
        self.received_label.grid(row=2, column=2, columnspan=2, padx=10, pady=5)
    ...
    def ask_username(self):
        ...
        confirm_button = ctk.CTkButton(dialog, text="Dołącz", command=on_confirm, text_color="black")
    ...
    def update_received_label(self):
        self.received_label.configure(text=f"Odebrane wiadomości: {self.received_messages}")
    ...
    def open_emoji_window(self):
        ...
        emoji_window.title("Wybierz emotkę")
        emoji_window.geometry("300x300")
        ...
        column_count = 0
        for emoji in emojis:
            button = ctk.CTkButton(emoji_window, text=emoji, width=80, height=60, font=("Arial", 22),
                                   command=lambda e=emoji: self.insert_emoji(e), corner_radius=10, text_color="black")
